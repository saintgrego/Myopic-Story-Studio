  ...
  "props": [
    {
      ...
      "scale": { "x": 1, "y": 1, "z": 1 },
      "visible": true,
      "mesh": { "kind": "primitive", "shape": "box|sphere|cylinder|cone|capsule", "dimensions": [number, ...] }
    }
  ],
...
- Prop meshes are ALWAYS "kind": "primitive". For props, never emit "kind": "gltf" — that variant is reserved for assets the user attaches by hand later.
